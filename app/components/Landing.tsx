  ...
  return (
    <div className="mx-auto flex w-full max-w-[760px] flex-col gap-10 px-6 pb-12 pt-10 text-center md:pt-16">
      <div className="flex flex-col items-center gap-5">
        ...
        <h1 className="font-serif text-5xl font-medium leading-[1.08] text-parchment md:text-6xl">
        ...
        <button
          ...
          onClick={onConnect}
          disabled={busy}
          className="mt-1 inline-flex h-[48px] items-center rounded-[10px] bg-safe px-8 text-[15px] font-semibold text-on-accent transition hover:brightness-110 disabled:opacity-50"
        >
